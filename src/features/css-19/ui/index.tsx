  ...
  return (
    <div class="container">
      ...
      <div class={style.cssChallenge19}>
        <section>
          <article>
            <img src="assets/images/css-challenge-19/capitol.jpg" alt="What's in and out of the government funding bill" />
            <h1>What's in and out of the government funding bill</h1>
          </article>

          <article>
            <img src="assets/images/css-challenge-19/romney.jpg"
          ...
          <article>
            <img src="assets/images/css-challenge-19/smerc.jpg" alt="Smerconish shares his take on the debt ceiling debate" />
            <h1>Smerconish shares his take on the debt ceiling debate</h1>
          </article>

          <article>
            <img src="assets/images/css-challenge-19/trump-tomlinson-split.jpg"
        ...
        <section>
          <article>
            <img src="assets/images/css-challenge-19/christmas-market.jpg"
              alt="Saudi Arabia warned Germany three times about market attack suspect, source says" />
            <h1>Saudi Arabia warned Germany three times about market attack suspect, source says</h1>
          </article>

          <article>
            <img src="assets/images/css-challenge-19/justice.jpg"
              alt="Durbin uses new report to accuse Justices Thomas and Alito of violating disclosure laws" />
            <h1>Durbin uses new report to accuse Justices Thomas and Alito of violating disclosure laws</h1>
          </article>
        </section>

        <section>
          <article>
            <img src="assets/images/css-challenge-19/football.jpg" alt="Here’s who’s playing today in the first round of the playoffs" />
            <h1>Here’s who’s playing today in the first round of the playoffs</h1>
          </article>

          <article>
            <img src="assets/images/css-challenge-19/brain-rot.jpg"
          ...
          <article>
            <img src="assets/images/css-challenge-19/injuries.jpg"
              alt="An estimated 16,000 people go to the hospital for holiday decor-related injuries each year" />
            <h1>An estimated 16,000 people go to the hospital for holiday decor-related injuries each year</h1>
          </article>
        </section>
      </div>
    </div>
